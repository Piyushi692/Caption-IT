    ...
    render() {
        ...
        let noquotediv = (quotes.length == 0) ? (
            ...
            <div className='quote-found-div'>
                <img src={cheersImg} />
                <h5>Here are the appropiate captions we found your image.</h5>
                <p>Click on any captions to copy it.</p>
            </div>
        );
        return (
